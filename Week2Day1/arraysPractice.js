...
//Write a function called reversedLooper that is given letters as it's only argument and loops through the given array backwards alerting every item in the array starting at the end.
  ...
  //Code Here
var reversedLooper = function(param) {
...
var myGroceryList = ['chips', 'pizza', 'hotpockets', 'MtnDew', 'corndogs'];
  ...
  //Code Here
var removeItem = function(groceryList, removeItem) {
  for (var i = 0; i < groceryList.length; i++) {
    if(removeItem === groceryList[i]) {
...
var addItem = function(groceryList, addItem) {
...
var addTen = function(array) {
  ...
  for (var i = 0; i < array.length; i++) {
    newArray[i] = parseInt(newArray[i]) + 10;
  }
  return newArray;
}
...
var comparison = function(array1, array2) {
  if (array1.length > array2.length) {
    console.log("Array 1 is longest");
    return array1;
  }
  else {
    console.log("Array 2 is longest");
    return array2;
  }
}
...
sure that it's equal to 4. */
  ...
  //Code Here
  devMountainEmployees.push({name: 'Tyler',
      position: 'Lead Instructor/Engineer',
